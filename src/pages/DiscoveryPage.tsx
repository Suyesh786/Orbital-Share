...
export function DiscoveryPage() {
  ...
  const showEmptyState =
    ...
    !rejectionMessage &&
    !noticeMessage
  const statusMessage = rejectionMessage ?? noticeMessage
    ...
    <div className="relative flex h-full flex-col">
      ...
      {isRequesting && selectedReceiver && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
        >
          <p className="flex items-center justify-center gap-2 text-center text-xs text-cyan-400/80">
            <motion.span
              className="size-3 rounded-full border border-cyan-300/25 border-t-cyan-300/90"
              animate={{ rotate: 360 }}
