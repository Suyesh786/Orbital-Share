  ...
  return (
    <AnimatePresence>
      {request && (
        ...
        >
          <div
            className="absolute inset-0 bg-[rgba(3,5,10,0.74)] backdrop-blur-md"
            aria-hidden
          />
          <div
            className="absolute inset-0 bg-[radial-gradient(circle_at_50%_42%,rgba(94,184,201,0.14),transparent_48%)]"
            aria-hidden
          />
          <motion.div
            className="glass-panel glow-cyan relative w-full max-w-[320px] rounded-2xl border border-cyan-400/24 p-5 shadow-[0_28px_90px_rgba(0,0,0,0.52)]"
