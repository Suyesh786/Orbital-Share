  ...
  return (
    <div
      className={cn(
        ...
        desktop
          ? "h-screen w-screen rounded-[13px]"
    ...
    >
      ...
      <div className="airspace-window-vignette pointer-events-none absolute inset-0 z-[2]" aria-hidden />
      ...
      <div className="relative z-10 flex h-full min-h-0 flex-col">
        ...
        <header className="electron-drag flex shrink-0 items-center gap-3 px-5 pt-4 pb-1 relative">
          <div data-tauri-drag-region className="absolute inset-0 z-0" aria-hidden />
          <div className="electron-no-drag w-[52px] shrink-0 relative z-10">
            <TrafficLights />
          </div>
