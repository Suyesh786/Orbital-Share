const RINGS = [
  { inset: "6%", className: "airspace-home-orbit-inner" },
  { inset: "20%", className: "airspace-home-orbit-outer" },
] as const
...
export function HomeOrbitAtmosphere() {
  return (
    <div
      ...
      aria-hidden
    >
      <div className="airspace-home-orbit-spotlight absolute inset-0 rounded-full" />
